  ...
  const ServicePopup = () => (
    <div className="fixed inset-0 z-[999] flex items-center justify-center"
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl relative overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center md:items-center p-6 border-b bg-[#f8fafb]">
        ...
        <div className="flex flex-1 overflow-hidden" style={{ minHeight: 380, height: "100%" }}>
          <aside
            className="border-r bg-[#f8fafb] py-4 flex flex-col gap-2"
            style={{
              width: 200,
          ...
          >
            <div className="text-xl font-semibold mb-3">{allCategories.find(c => c.id === selectedCategory)?.label}</div>
            <div className="space-y-3">
              {allCategories.find(c => c.id === selectedCategory)?.services.length > 0 ? (
                allCategories.find(c => c.id === selectedCategory).services.map(service => (
                  <div key={service.id} className="flex items-center justify-between bg-[#f6f8fa] p-3 rounded-xl shadow-sm border mb-2" style={{ borderColor: "#bdbdbd" }}>
              ...
              {selectedCategory === allCategories[allCategories.length-1].id && (
                <div style={{marginTop: 16, background: "#F5F5F5", border: "1px solid #eee", padding: 12, fontWeight: 'bold'}}>
